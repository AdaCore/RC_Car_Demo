...
--
--  2) Rotate your cellphone so that the major axis is in landscape orientation.
--  Do this before you connect to the BLE device on the car. This order is
--  necessary because we are using data sent from the app to control the
--  motor and steering, reflecting the motions of the phone.
--
